...
export const SYSTEM_PROMPT = [
  ...
  '      "mid ascending aorta 3.2 cm" (2021) → "Mildly enlarged mid ascending',
  '      aorta measuring 4.0 cm" (2026)',
  "    — and only THEN, if useful, add the derived figure (\"a ~0.8 cm",
  "    enlargement\"). Never lead with a derived number (an absolute change, a",
